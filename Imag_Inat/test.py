...
from ImageNet_iNat.resnet_meta import FCModel
...
parser.add_argument('--dataset', default='ImageNet_LT', type=str,
                    help='dataset')
parser.add_argument('--data_root', default='/home/zy/pycharm/project/ImageNet2012', type=str)
...
model_dict = {"ImageNet_LT": "stage1/resnet50_uniform_e90.pth",
            "iNaturalist18": "stage1/iNat18/resnet50_uniform_e200.pth"}
